    ...
    <div>
      ...
      >
        ...
        <div className="flex relative w-full min-w-[320px]">
          ...
          >
            <ListboxOptions
              className="absolute -bottom-[calc(100%-36px)] left-0 xsmall:left-auto xsmall:right-0 max-h-[442px] overflow-y-scroll z-[900] bg-zinc-900 border border-white/10 drop-shadow-xl text-small-regular uppercase text-zinc-200 no-scrollbar rounded-xl w-full"
              static
            >
              {options.map((o) => (
                <ListboxOption
                  key={o.code || "default"}
                  value={o}
                  className="py-2 hover:bg-zinc-800 px-3 cursor-pointer flex items-center gap-x-2 transition-colors"
                >
                  {o.countryCode ? (
                    /* @ts-ignore */
                    <ReactCountryFlag
